...
@interface McKinney_Sequester_Project1Object : KrollCoverageObject {
#else
@interface McKinney_Sequester_Project1Object : KrollObject {
#endif
@private
...
extern NSString * McKinney_Sequester_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	McKinney_Sequester_Project1Object *_mckinney_sequester_project1;
    KrollObject* console;
	BOOL shutdown;
