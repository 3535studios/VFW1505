...
// in simulator we redefine to format for McKinney_Sequester_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.mckinney_sequester_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mckinney_sequester_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMcKinney_Sequester_Project1NativeItemNone = -1, 
	UIMcKinney_Sequester_Project1NativeItemSpinner = -2,
	UIMcKinney_Sequester_Project1NativeItemProgressBar = -3,
	
	UIMcKinney_Sequester_Project1NativeItemSlider = -4,
	UIMcKinney_Sequester_Project1NativeItemSwitch = -5,
	UIMcKinney_Sequester_Project1NativeItemMultiButton = -6,
	UIMcKinney_Sequester_Project1NativeItemSegmented = -7,
	
	UIMcKinney_Sequester_Project1NativeItemTextView = -8,
	UIMcKinney_Sequester_Project1NativeItemTextField = -9,
	UIMcKinney_Sequester_Project1NativeItemSearchBar = -10,
	
	UIMcKinney_Sequester_Project1NativeItemPicker = -11,
	UIMcKinney_Sequester_Project1NativeItemDatePicker = -12,
	
	UIMcKinney_Sequester_Project1NativeItemInfoLight = -13,
	UIMcKinney_Sequester_Project1NativeItemInfoDark = -14,
	
	UIMcKinney_Sequester_Project1NativeItemDisclosure = -15,
	
	UIMcKinney_Sequester_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all McKinney_Sequester_Project1 instances of
