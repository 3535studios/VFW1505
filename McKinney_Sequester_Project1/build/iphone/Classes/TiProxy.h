...
//Rare exceptions to indicate a bug in the _mckinney_sequester_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for McKinney_Sequester_Project1 proxies.
 */
