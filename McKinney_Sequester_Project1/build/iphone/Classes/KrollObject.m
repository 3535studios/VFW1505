...
//@interface McKinney_Sequester_Project1Object : NSObject
//@end

@interface McKinney_Sequester_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[McKinney_Sequester_Project1Object class]])
		{
			for (NSString *key in [[(McKinney_Sequester_Project1Object*)o modules] allKeys])
			{
