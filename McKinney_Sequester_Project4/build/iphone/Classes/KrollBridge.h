...
@interface McKinney_Sequester_Project4Object : KrollCoverageObject {
#else
@interface McKinney_Sequester_Project4Object : KrollObject {
#endif
@private
...
extern NSString * McKinney_Sequester_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	McKinney_Sequester_Project4Object *_mckinney_sequester_project4;
    KrollObject* console;
	BOOL shutdown;
