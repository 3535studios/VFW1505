...
// in simulator we redefine to format for McKinney_Sequester_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.mckinney_sequester_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mckinney_sequester_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMcKinney_Sequester_Project4NativeItemNone = -1, 
	UIMcKinney_Sequester_Project4NativeItemSpinner = -2,
	UIMcKinney_Sequester_Project4NativeItemProgressBar = -3,
	
	UIMcKinney_Sequester_Project4NativeItemSlider = -4,
	UIMcKinney_Sequester_Project4NativeItemSwitch = -5,
	UIMcKinney_Sequester_Project4NativeItemMultiButton = -6,
	UIMcKinney_Sequester_Project4NativeItemSegmented = -7,
	
	UIMcKinney_Sequester_Project4NativeItemTextView = -8,
	UIMcKinney_Sequester_Project4NativeItemTextField = -9,
	UIMcKinney_Sequester_Project4NativeItemSearchBar = -10,
	
	UIMcKinney_Sequester_Project4NativeItemPicker = -11,
	UIMcKinney_Sequester_Project4NativeItemDatePicker = -12,
	
	UIMcKinney_Sequester_Project4NativeItemInfoLight = -13,
	UIMcKinney_Sequester_Project4NativeItemInfoDark = -14,
	
	UIMcKinney_Sequester_Project4NativeItemDisclosure = -15,
	
	UIMcKinney_Sequester_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all McKinney_Sequester_Project4 instances of
