...
//@interface McKinney_Sequester_Project4Object : NSObject
//@end

@interface McKinney_Sequester_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[McKinney_Sequester_Project4Object class]])
		{
			for (NSString *key in [[(McKinney_Sequester_Project4Object*)o modules] allKeys])
			{
