 ...
 * to send analytic data that can be viewed on the McKinney_Sequester_Project4 Dashboard.
 *
 * For information on getting started with McKinney_Sequester_Project4 Platform Services,
