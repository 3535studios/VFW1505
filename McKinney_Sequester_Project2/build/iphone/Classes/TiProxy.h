...
//Rare exceptions to indicate a bug in the _mckinney_sequester_project2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for McKinney_Sequester_Project2 proxies.
 */
