...
//@interface McKinney_Sequester_createWindowObject : NSObject
//@end

@interface McKinney_Sequester_createWindowObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[McKinney_Sequester_createWindowObject class]])
		{
			for (NSString *key in [[(McKinney_Sequester_createWindowObject*)o modules] allKeys])
			{
