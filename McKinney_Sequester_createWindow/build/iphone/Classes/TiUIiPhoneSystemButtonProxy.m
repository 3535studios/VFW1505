...
MAKE_SYSTEM_PROP(ACTIVITY,UIMcKinney_Sequester_createWindowNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIMcKinney_Sequester_createWindowNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIMcKinney_Sequester_createWindowNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIMcKinney_Sequester_createWindowNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIMcKinney_Sequester_createWindowNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIMcKinney_Sequester_createWindowNativeItemContactAdd);
