...
/**
 Base class for all McKinney_Sequester_createWindow views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the McKinney_Sequester_createWindow view hierarchy (such as wrapped iOS UIViews) was touched.
