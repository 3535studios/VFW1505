...
@interface McKinney_Sequester_createWindowObject : KrollCoverageObject {
#else
@interface McKinney_Sequester_createWindowObject : KrollObject {
#endif
@private
...
extern NSString * McKinney_Sequester_createWindow$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	McKinney_Sequester_createWindowObject *_mckinney_sequester_createwindow;
    KrollObject* console;
	BOOL shutdown;
