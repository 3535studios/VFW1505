...
// in simulator we redefine to format for McKinney_Sequester_createWindow Developer console
...
{\
	NSString * exceptionName = [@"org.mckinney_sequester_createwindow." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mckinney_sequester_createwindow";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMcKinney_Sequester_createWindowNativeItemNone = -1, 
	UIMcKinney_Sequester_createWindowNativeItemSpinner = -2,
	UIMcKinney_Sequester_createWindowNativeItemProgressBar = -3,
	
	UIMcKinney_Sequester_createWindowNativeItemSlider = -4,
	UIMcKinney_Sequester_createWindowNativeItemSwitch = -5,
	UIMcKinney_Sequester_createWindowNativeItemMultiButton = -6,
	UIMcKinney_Sequester_createWindowNativeItemSegmented = -7,
	
	UIMcKinney_Sequester_createWindowNativeItemTextView = -8,
	UIMcKinney_Sequester_createWindowNativeItemTextField = -9,
	UIMcKinney_Sequester_createWindowNativeItemSearchBar = -10,
	
	UIMcKinney_Sequester_createWindowNativeItemPicker = -11,
	UIMcKinney_Sequester_createWindowNativeItemDatePicker = -12,
	
	UIMcKinney_Sequester_createWindowNativeItemInfoLight = -13,
	UIMcKinney_Sequester_createWindowNativeItemInfoDark = -14,
	
	UIMcKinney_Sequester_createWindowNativeItemDisclosure = -15,
	
	UIMcKinney_Sequester_createWindowNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all McKinney_Sequester_createWindow instances of
