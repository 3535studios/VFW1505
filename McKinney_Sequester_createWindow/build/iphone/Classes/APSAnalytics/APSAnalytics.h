 ...
 * to send analytic data that can be viewed on the McKinney_Sequester_createWindow Dashboard.
 *
 * For information on getting started with McKinney_Sequester_createWindow Platform Services,
