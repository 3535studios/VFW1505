...
//Rare exceptions to indicate a bug in the _mckinney_sequester_createwindow code (Eg, function that a subclass should have implemented)
...
/**
 The base class for McKinney_Sequester_createWindow proxies.
 */
