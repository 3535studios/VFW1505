...
@interface McKinney_Sequester_Project3Object : KrollCoverageObject {
#else
@interface McKinney_Sequester_Project3Object : KrollObject {
#endif
@private
...
extern NSString * McKinney_Sequester_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	McKinney_Sequester_Project3Object *_mckinney_sequester_project3;
    KrollObject* console;
	BOOL shutdown;
