...
// in simulator we redefine to format for McKinney_Sequester_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.mckinney_sequester_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mckinney_sequester_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMcKinney_Sequester_Project3NativeItemNone = -1, 
	UIMcKinney_Sequester_Project3NativeItemSpinner = -2,
	UIMcKinney_Sequester_Project3NativeItemProgressBar = -3,
	
	UIMcKinney_Sequester_Project3NativeItemSlider = -4,
	UIMcKinney_Sequester_Project3NativeItemSwitch = -5,
	UIMcKinney_Sequester_Project3NativeItemMultiButton = -6,
	UIMcKinney_Sequester_Project3NativeItemSegmented = -7,
	
	UIMcKinney_Sequester_Project3NativeItemTextView = -8,
	UIMcKinney_Sequester_Project3NativeItemTextField = -9,
	UIMcKinney_Sequester_Project3NativeItemSearchBar = -10,
	
	UIMcKinney_Sequester_Project3NativeItemPicker = -11,
	UIMcKinney_Sequester_Project3NativeItemDatePicker = -12,
	
	UIMcKinney_Sequester_Project3NativeItemInfoLight = -13,
	UIMcKinney_Sequester_Project3NativeItemInfoDark = -14,
	
	UIMcKinney_Sequester_Project3NativeItemDisclosure = -15,
	
	UIMcKinney_Sequester_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all McKinney_Sequester_Project3 instances of
