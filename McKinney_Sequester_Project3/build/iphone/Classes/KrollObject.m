...
//@interface McKinney_Sequester_Project3Object : NSObject
//@end

@interface McKinney_Sequester_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[McKinney_Sequester_Project3Object class]])
		{
			for (NSString *key in [[(McKinney_Sequester_Project3Object*)o modules] allKeys])
			{
