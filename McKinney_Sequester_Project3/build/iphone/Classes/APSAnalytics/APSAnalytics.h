 ...
 * to send analytic data that can be viewed on the McKinney_Sequester_Project3 Dashboard.
 *
 * For information on getting started with McKinney_Sequester_Project3 Platform Services,
