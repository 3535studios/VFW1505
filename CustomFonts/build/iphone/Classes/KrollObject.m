...
//@interface CustomFontsObject : NSObject
//@end

@interface CustomFontsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CustomFontsObject class]])
		{
			for (NSString *key in [[(CustomFontsObject*)o modules] allKeys])
			{
