...
/**
 Base class for all CustomFonts views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CustomFonts view hierarchy (such as wrapped iOS UIViews) was touched.
