...
// in simulator we redefine to format for CustomFonts Developer console
...
{\
	NSString * exceptionName = [@"org.customfonts." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.customfonts";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICustomFontsNativeItemNone = -1, 
	UICustomFontsNativeItemSpinner = -2,
	UICustomFontsNativeItemProgressBar = -3,
	
	UICustomFontsNativeItemSlider = -4,
	UICustomFontsNativeItemSwitch = -5,
	UICustomFontsNativeItemMultiButton = -6,
	UICustomFontsNativeItemSegmented = -7,
	
	UICustomFontsNativeItemTextView = -8,
	UICustomFontsNativeItemTextField = -9,
	UICustomFontsNativeItemSearchBar = -10,
	
	UICustomFontsNativeItemPicker = -11,
	UICustomFontsNativeItemDatePicker = -12,
	
	UICustomFontsNativeItemInfoLight = -13,
	UICustomFontsNativeItemInfoDark = -14,
	
	UICustomFontsNativeItemDisclosure = -15,
	
	UICustomFontsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CustomFonts instances of
