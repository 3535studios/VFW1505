...
@interface CustomFontsObject : KrollCoverageObject {
#else
@interface CustomFontsObject : KrollObject {
#endif
@private
...
extern NSString * CustomFonts$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	CustomFontsObject *_customfonts;
    KrollObject* console;
	BOOL shutdown;
